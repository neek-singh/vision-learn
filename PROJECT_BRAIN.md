...
| 2026-07-20 | Antigravity | [LessonViewer.tsx](file:///c:/Users/as007/vision-learn/components/student/LessonViewer.tsx), [CurriculumClient.tsx](file:///c:/Users/as007/vision-learn/components/student/CurriculumClient.tsx) | Implemented **Live Active Time Tracker**! Automatically tracks active study time in seconds while a student is actively viewing/reading/watching any class in LessonViewer (only when browser tab is active). Accumulates both cumulative and daily active study time in localStorage (`vision_active_seconds` & `vision_daily_active`), broadcasting live tick events. Updated the **Hours Learnt** stat card on the My Classes page to combine completed lesson duration with real-time active study time, featuring a pulsing green "Live" badge. |
