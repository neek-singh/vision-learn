...
| 2026-07-03 | Antigravity | [globals.css](file:///c:/Users/as007/vision-learn/app/globals.css) | Copied rich text content styling rules (`.rich-content`, lists, headings, images, hr) from `vision-admin` to ensure lesson notes formatting is displayed beautifully on the student interface. |
| 2026-07-03 | Antigravity | [LessonViewer.tsx](file:///c:/Users/as007/vision-learn/components/student/LessonViewer.tsx) | Integrated interactive Quiz UI form rendering for `mcq` lesson types, managed local answer states, and parsed questions comment payload. |
| 2026-07-03 | Antigravity | [CurriculumClient.tsx](file:///c:/Users/as007/vision-learn/components/student/CurriculumClient.tsx), [LessonViewer.tsx](file:///c:/Users/as007/vision-learn/components/student/LessonViewer.tsx), [DashboardClient.tsx](file:///c:/Users/as007/vision-learn/components/dashboard/DashboardClient.tsx) | Added dynamic icons, titles (e.g., Quiz/Assignment instead of Class) on Curriculum list, Curriculum Next Up card, and Dashboard widgets. Implemented iOS/mobile scroll lock and flex layout height containment in the Quiz modal to fix mobile scrolling. |
| 2026-07-04 | Antigravity | [CurriculumClient.tsx](file:///c:/Users/as007/vision-learn/components/student/CurriculumClient.tsx), [LessonViewer.tsx](file:///c:/Users/as007/vision-learn/components/student/LessonViewer.tsx), [DashboardClient.tsx](file:///c:/Users/as007/vision-learn/components/dashboard/DashboardClient.tsx), [page.tsx](file:///c:/Users/as007/vision-learn/app/(dashboard)/dashboard/page.tsx), [DashboardComponents.tsx](file:///c:/Users/as007/vision-learn/components/dashboard/DashboardComponents.tsx), [TestsClient.tsx](file:///c:/Users/as007/vision-learn/app/(dashboard)/tests/TestsClient.tsx), [AssignmentsClient.tsx](file:///c:/Users/as007/vision-learn/app/(dashboard)/assignments/AssignmentsClient.tsx) | Added format-specific colors (amber for assignments, indigo for projects, purple for quizzes) to curriculum item icon containers. Added `FolderCode` icon to projects. Restructured `In Progress` status badge to display only for standard class formats (video, notes, article, document). Added database column `lesson_id` to `submissions` table and implemented submission panel in `LessonViewer.tsx` allowing students to submit solution URL links for assignments/projects, and submit scores for quizzes. Removed retry option and hid the submit button block after MCQ quiz submission to show only the score. Conditionally hid the bottom completion actions container (Mark as Incomplete, Skip) once a lesson is marked as completed. Fixed student dashboard and My Classes curriculum page showing quiz, assignment, and project completions as class completions by properly separating lesson types in server queries and client component state calculations. Added separate stat cards for Classes, Quizzes, Assignments, and Projects on the main dashboard. Integrated scheduled curriculum quizzes and assignments into the standalone Online Tests and Assignments dashboard pages. Resolved hydration mismatch by introducing mounted state checks in both TestsClient and AssignmentsClient components, and placed the early-return checks after React hook declarations to strictly adhere to hook order rules. |
| 2026-07-05 | Antigravity | [DashboardClient.tsx](file:///c:/Users/as007/vision-learn/components/dashboard/DashboardClient.tsx), [NotificationsClient.tsx](file:///c:/Users/as007/vision-learn/app/(dashboard)/notifications/NotificationsClient.tsx), [AssignmentsClient.tsx](file:///c:/Users/as007/vision-learn/app/(dashboard)/assignments/AssignmentsClient.tsx), [page.tsx](file:///c:/Users/as007/vision-learn/app/(dashboard)/assignments/page.tsx), [TestsClient.tsx](file:///c:/Users/as007/vision-learn/app/(dashboard)/tests/TestsClient.tsx), [CalendarClient.tsx](file:///c:/Users/as007/vision-learn/app/(dashboard)/calendar/CalendarClient.tsx), [StudentFeesClient.tsx](file:///c:/Users/as007/vision-learn/components/student/StudentFeesClient.tsx) | Made dashboard navigation tabs mobile-responsive by hiding text labels and showing only larger, squish-free icons on mobile viewports. Replaced desktop table layout with card layout on the Assignments page for mobile devices. Redesigned Notification Inbox cards to support vertical layout stacking on mobile screens, avoiding badge and timestamp overlapping. Refactored the Submit Assignment modal to expand to full-screen on mobile devices for improved focus and tap accessibility, while maintaining centered popup styling on desktop. Cleaned up quiz score formatting from '5/5/—' to '5/5' in TestsClient.tsx, and updated curriculum quiz links to direct students to '/curriculum?lessonId={id}' to launch the target quiz modal instantly on click. Integrated project-type curriculum lessons and schedules into the Assignments dashboard page with dynamic badges, FolderCode icon, and customized submission modal labels ("Submit Project") for a seamless, clean UX. Refactored CalendarClient.tsx to render clean colored dots inside day cells on mobile viewports to prevent squished layout, mapped project/quiz types to specific colors and FolderCode/FileText icons, resolved duplicate event legend counts by normalizing event type keys to lowercase, and replaced the class video camera icon with `BookOpen` since class schedules are for reading. Refactored StudentFeesClient.tsx to render Current Balance and the SVG Donut chart side-by-side in a responsive row on mobile/tablets, and reorganized quick stats into a clean grid to prevent vertically stretched main card layout. |
| 2026-07-06 | Antigravity | [CalendarClient.tsx](file:///c:/Users/as007/vision-learn/app/(dashboard)/calendar/CalendarClient.tsx), [page.tsx](file:///c:/Users/as007/vision-learn/app/(dashboard)/calendar/page.tsx), [page.tsx](file:///c:/Users/as007/vision-learn/app/(dashboard)/dashboard/page.tsx), [DashboardComponents.tsx](file:///c:/Users/as007/vision-learn/components/dashboard/DashboardComponents.tsx) | Highlighted Sundays on the Student Learning Calendar (header, cell backgrounds, and date numbers) with a rose-themed styling to mark weekends/holidays. Added course filtering logic to student calendar page and dashboard page to query and display only public events/holidays or course-specific events that match the student's enrolled courses. Removed timing and "Online" location details from the student calendar details panel and dashboard card listings for holiday and event types. |
| 2026-07-20 | Antigravity | [CurriculumClient.tsx](file:///c:/Users/as007/vision-learn/components/student/CurriculumClient.tsx) | Added two tabs to the My Classes (Curriculum) page: **Syllabus** tab shows the existing module-grouped accordion view, and **Series** tab shows all classes in chronological timeline order based on scheduled dates. Updated Series view with a compact orange/amber theme, date pills with dark text, and hidden unscheduled lessons. |
| 2026-07-20 | Antigravity | [ProfilePhotoViewer.tsx](file:///c:/Users/as007/vision-learn/components/student/ProfilePhotoViewer.tsx), [page.tsx](file:///c:/Users/as007/vision-learn/app/(dashboard)/profile/page.tsx), [layout.tsx](file:///c:/Users/as007/vision-learn/app/(dashboard)/layout.tsx), [SyncStatus.tsx](file:///c:/Users/as007/vision-learn/components/SyncStatus.tsx) | Created ProfilePhotoViewer component for the Student Profile page allowing students to click their avatar photo to expand it to a larger size (w-80) and click again to shrink back. Removed and hid the top header SyncStatus status widget. |
| 2026-07-20 | Antigravity | [LessonViewer.tsx](file:///c:/Users/as007/vision-learn/components/student/LessonViewer.tsx), [CurriculumClient.tsx](file:///c:/Users/as007/vision-learn/components/student/CurriculumClient.tsx) | Implemented **Live Active Time Tracker** to track active study seconds in LessonViewer and update Hours Learnt stat card live. Updated `expandedModules` initial state in `CurriculumClient.tsx` to empty array `[]` so all modules stay collapsed by default when switching to/viewing the Syllabus tab. Hidden `Mark as Complete` and `Skip for now` action buttons in `LessonViewer.tsx` specifically for MCQ Quiz type lessons. Refactored MCQ Quiz rendering in `LessonViewer.tsx` to display **one question at a time** with Q1, Q2, Q3 step pills, Previous/Next navigation controls, 2x2 compact desktop grid layout for options, and direct **Submit Quiz** button on the final question. Implemented **Silent Anti-Screenshot & Copy Protection** for Quizzes with **Auto-Close Quiz on PrtScn** keypress. Added **Unsubmitted Quiz Exit Warning Modal** and native `beforeunload` listener to warn students if they attempt to exit or refresh without submitting their quiz answers. |
| 2026-07-22 | Antigravity | [page.tsx](file:///c:/Users/as007/vision-learn/app/(dashboard)/dashboard/page.tsx), [DashboardClient.tsx](file:///c:/Users/as007/vision-learn/components/dashboard/DashboardClient.tsx), [page.tsx](file:///c:/Users/as007/vision-learn/app/(dashboard)/profile/page.tsx), [CurriculumClient.tsx](file:///c:/Users/as007/vision-learn/components/student/CurriculumClient.tsx) | Queried the `batches` database table to extract and display the timing associated with the student's assigned batch. Rendered the batch timing on the main Student Dashboard header, the Assigned Batch field on the Student Profile page, and next to the active batch name on the Curriculum (My Classes) page. |
| 2026-07-22 | Antigravity | [DashboardClient.tsx](file:///c:/Users/as007/vision-learn/components/dashboard/DashboardClient.tsx) | Removed the "Student Hub" badge from the dashboard greeting banner and enlarged the batch name and timing badges (`text-[11px]`, padding `px-3 py-1`, icon `size={12}`). |
| 2026-07-22 | Antigravity | [LessonViewer.tsx](file:///c:/Users/as007/vision-learn/components/student/LessonViewer.tsx) | Implemented two-finger touch pinch-to-zoom gesture on the notes/theory content container for mobile devices, enabling interactive font size scaling from 12px to 28px while preventing default browser viewport zoom. |
| 2026-07-22 | Antigravity | [CurriculumClient.tsx](file:///c:/Users/as007/vision-learn/components/student/CurriculumClient.tsx) | Removed the batch, timing, offline access download button, and lightning bolt card from the My Classes (Curriculum) header to keep the syllabus header layout clean and minimalist. |
